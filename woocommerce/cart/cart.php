...
require get_template_directory() . '/inc/categoriesButtons.php';
			...
			<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
				<thead>
					<tr>
						...
						<th class="product-price"><?php esc_html_e( 'Цена, руб', 'woocommerce' ); ?></th>
						<th class="product-subtotal"><?php esc_html_e( 'Сумма, руб', 'woocommerce' ); ?></th>
				...
				<tbody>
						...
						if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
							...
							<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
								...
								<td class="product-quantity" data-title="<?php esc_attr_e( 'Quantity', 'woocommerce' ); ?>">
									<?php
									// var_dump($_product->is_sold_individually());
					...
					<tr>
						<td colspan="6" class="actions">
							...
							<button type="submit" class="btn btn_border" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
