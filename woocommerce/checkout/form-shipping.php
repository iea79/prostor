...
<div class="woocommerce-shipping-fields">
	<?php if ( true === WC()->cart->needs_shipping_address() ) : ?>
		...
		<h3 id="ship-to-different-address" class="checkoutForm__title">
				...
				<?php esc_html_e( 'Доставка / оплата', 'woocommerce' ); ?>
		</h3>

		<!-- <h3 class="checkoutForm__title"><?php esc_html_e( 'Доставка / оплата', 'woocommerce' ); ?></h3> -->
